...
static const struct pinctrl_pin_desc msm8610_pins[] = {
	...
	PINCTRL_PIN(102, "SDC1_CLK"),
	PINCTRL_PIN(103, "SDC1_CMD"),
	PINCTRL_PIN(104, "SDC1_DATA"),
	PINCTRL_PIN(105, "SDC2_CLK"),
	PINCTRL_PIN(106, "SDC2_CMD"),
	PINCTRL_PIN(107, "SDC2_DATA"),
};
...
static const unsigned int sdc1_clk_pins[] = { 102 };
static const unsigned int sdc1_cmd_pins[] = { 103 };
static const unsigned int sdc1_data_pins[] = { 104 };
static const unsigned int sdc2_clk_pins[] = { 105 };
static const unsigned int sdc2_cmd_pins[] = { 106 };
static const unsigned int sdc2_data_pins[] = { 107 };
...
static const char * const cci_i2c0_groups[] = { "gpio16", "gpio17" };

static const char * const cam_mclk0_groups[] = { "gpio13" };
static const char * const cam_mclk1_groups[] = { "gpio14" };

static const char * const wlan_groups[] = {
	"gpio23", "gpio24", "gpio25", "gpio26", "gpio27"
};

static const struct msm_function msm8610_functions[] = {
	FUNCTION(gpio),
	FUNCTION(cci_i2c0),
	FUNCTION(blsp_uim1),
	FUNCTION(blsp_uim3),
...
static const struct msm_pingroup msm8610_groups[] = {
	...
	PINGROUP(4,   NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(5,   NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(6,   NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(7,   NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(13,  cam_mclk0, NA, NA, NA, NA, NA, NA),
	PINGROUP(14,  cam_mclk1, NA, NA, NA, NA, NA, NA),
	PINGROUP(15,  NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(16,  blsp_spi5, blsp_uart5, blsp_uim5, cci_i2c0, NA, NA, NA),
	PINGROUP(17,  blsp_spi5, blsp_uart5, blsp_uim5, cci_i2c0, NA, NA, NA),
	...
	PINGROUP(23,  wlan, NA, NA, NA, NA, NA, NA),
	PINGROUP(24,  wlan, NA, NA, NA, NA, NA, NA),
	PINGROUP(25,  wlan, NA, NA, NA, NA, NA, NA),
	PINGROUP(26,  wlan, NA, NA, NA, NA, NA, NA),
	PINGROUP(27,  wlan, NA, NA, NA, NA, NA, NA),
	PINGROUP(28,  NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(29,  NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(30,  NA, NA, NA, NA, NA, NA, NA),
...
#define NUM_GPIO_PINGROUPS 102

static const struct msm_pinctrl_soc_data msm8610_pinctrl = {
	.pins = msm8610_pins,
	.npins = ARRAY_SIZE(msm8610_pins),
	.functions = msm8610_functions,
	.nfunctions = ARRAY_SIZE(msm8610_functions),
	.groups = msm8610_groups,
	.ngroups = ARRAY_SIZE(msm8610_groups),
	.ngpios = NUM_GPIO_PINGROUPS,
};

static int msm8610_pinctrl_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &msm8610_pinctrl);
}

static const struct of_device_id msm8610_pinctrl_of_match[] = {
	{ .compatible = "qcom,msm8610-pinctrl", },
	{ },
};

static struct platform_driver msm8610_pinctrl_driver = {
	.driver = {
		.name = "msm8610-pinctrl",
		.of_match_table = msm8610_pinctrl_of_match,
	},
	.probe = msm8610_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init msm8610_pinctrl_init(void)
{
	return platform_driver_register(&msm8610_pinctrl_driver);
}
arch_initcall(msm8610_pinctrl_init);

static void __exit msm8610_pinctrl_exit(void)
{
	platform_driver_unregister(&msm8610_pinctrl_driver);
}
module_exit(msm8610_pinctrl_exit);

MODULE_AUTHOR("Ivaylo Ivanov <ivo.ivanov@null.net>");
MODULE_DESCRIPTION("Qualcomm MSM8610 pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, msm8610_pinctrl_of_match);
