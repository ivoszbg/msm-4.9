...
static const struct freq_tbl ftbl_gcc_usb_hs_system_clk_msm8610[] = {
	F(75000000, P_GPLL0, 8, 0, 0),
	{ }
};
...
static struct clk_regmap *gcc_msm8610_clocks[] = {
	[GPLL0] = &gpll0.clkr,
...
static const struct qcom_reset_map gcc_msm8610_resets[] = {
	[GCC_USB_HS_BCR] = { 0x0480 },
	[GCC_USB2A_PHY_BCR] = { 0x04a8 },
};

static const struct regmap_config gcc_msm8610_regmap_config = {
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
	.max_register	= 0x2000,
...
static const struct qcom_cc_desc gcc_msm8610_desc = {
	.config = &gcc_msm8610_regmap_config,
	.clks = gcc_msm8610_clocks,
	.num_clks = ARRAY_SIZE(gcc_msm8610_clocks),
	.resets = gcc_msm8610_resets,
	.num_resets = ARRAY_SIZE(gcc_msm8610_resets),
};
...
static const struct of_device_id gcc_msm8974_match_table[] = {
	{ .compatible = "qcom,gcc-msm8610", .data = &gcc_msm8610_desc },
...
static void msm8610_clock_override(void)
{
	...
	usb_hs_system_clk_src.freq_tbl = ftbl_gcc_usb_hs_system_clk_msm8610;
}
...
static int gcc_msm8974_probe(struct platform_device *pdev)
{
	...
	if (!of_device_is_compatible(dev->of_node, "qcom,gcc-msm8974")) {
		...
		else if (id->data == &gcc_msm8610_desc)
			msm8610_clock_override();
		else
